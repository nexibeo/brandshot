...
import { renderAsset, normalizeBrand } from './templates.js';
import { ASSETS, selectAssets, pixelSize, TEXT_LIMITS } from './specs.js';
import { encodeConfig, esc } from './util.js';
...
if (cmd === 'init') {
  ...
  const example = new URL('../assets/brand.example.json', import.meta.url);
